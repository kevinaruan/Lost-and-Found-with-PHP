    ...
    $query = mysqli_query($data, "SELECT * FROM formditemukan WHERE id = $id");
...
<form method="post" enctype="multipart/form-data" action="editbarangditemukan.php">
    <br>
    ...
    <div class="form-group ">
        ...
        <div class="form-group">
            <input type="text" name="penemuBarang" class="form-control" id="pemilik" placeholder="Nama yang kehilangan barang" value="<?= $satu['penemuBarang']; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="date" name="tanggalDitemukan" class="form-control" id="tanggal" value="<?= $satu['tanggalDitemukan']; ?>">
        </div>
        <div class="form-group">

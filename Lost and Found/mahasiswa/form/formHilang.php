...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      if(in_array($ekstensi, $ekstensi_diperbolehkan)=== true){
        ...
        $query = mysqli_query($data, "INSERT INTO formbaranghilang VALUES ('','$gambarBarang', '$namaBarang','$pemilikBarang','$noHp','$ciriBarang','$tanggalHilang', '$lokasi', '$kategori')");
...
<form method="post" enctype="multipart/form-data">
    ...
    <h3 style="font-family: Century751 No2 BT;">Form Barang Hilang</h3><hr>
        ...
        <div class="form-group">
            <input type="text" class="form-control" id="pemilikBarang" placeholder="Nama yang kehilangan barang" name="pemilikBarang">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input type="text" class="form-control" id="lokasiHilang" placeholder="Lokasi Barang Hilang" name="lokasi">
        </div>
        <div class="form-group ">

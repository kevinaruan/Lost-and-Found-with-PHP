...
<body style="background-color: #ebe7e0;">
    ...
    <br><br>
    <center>
        <a href="ditemukan/daftarelektronik.php"><button type="button" class="btn btn-outline-info">Daftar Barang Elektronik</button></a>
        <a href="ditemukan/daftarnon.php"><button type="button" class="btn btn-outline-info">Daftar Barang NonElektronik</button></a>
        <a href="ditemukan/daftaruang.php"><button type="button" class="btn btn-outline-info">Daftar Barang Uang</button></a>
